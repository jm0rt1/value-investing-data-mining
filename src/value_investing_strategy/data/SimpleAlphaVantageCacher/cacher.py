...
from src.value_investing_strategy.strategy_system.stocks.alpha_vantage.alpha_vantage_client import AlphaVantageClient  # nopep8
...
if __name__ == "__main__":
    ...
    config_file_path = "src/value_investing_strategy/data/SimpleAlphaVantageCacher/config/cacher_config.toml"
