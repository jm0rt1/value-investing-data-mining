...
from src.value_investing_strategy.strategy_system.stocks.stock.components.income_statement import IncomeStatement
from src.value_investing_strategy.strategy_system.stocks.stock.components.earnings import EarningsStatement
from src.value_investing_strategy.strategy_system.stocks.stock.components.balance_sheet import BalanceSheet
from src.value_investing_strategy.strategy_system.stocks.stock.components.cash_flow import Cashflow
from src.value_investing_strategy.strategy_system.stocks.stock.components.company_overview import CompanyOverview
import pandas as pd

from src.value_investing_strategy.strategy_system.stocks.stock.components.time_series import TimeSeriesMonthly


def get_valid_path():

    default_path = "./src/value_investing_strategy/data/SimpleAlphaVantageCacher/output/json_cache/DATA"
