...
from src.value_investing_strategy.strategy_system.strategy_interface import StrategyInterface
from src.value_investing_strategy.strategy_system.stocks.stock.stock import Stock, PATH_TO_STOCK_DATA
...
def get_data_path():
    ...
    result = Path(os.path.join(
        parent_dir, "data/SimpleAlphaVantageCacher/output/json_cache/covered.txt"))
    return result
